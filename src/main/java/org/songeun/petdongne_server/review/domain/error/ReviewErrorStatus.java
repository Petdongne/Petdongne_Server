...
public enum ReviewErrorStatus implements ErrorStatus {
    ...
    REVIEW_AVERAGE_RATING_REQUIRED(HttpStatus.BAD_REQUEST, "REVIEW_AVERAGE_RATING_REQUIRED", "리뷰 평균 평점은 NULL일 수 없습니다."),

    REVIEW_USER_REQUIRED(HttpStatus.BAD_REQUEST, "REVIEW_USER_REQUIRED", "리뷰 작성자는 NULL일 수 없습니다."),
    REVIEW_RESIDENTIAL_COMPLEX_REQUIRED(HttpStatus.BAD_REQUEST, "REVIEW_RESIDENTIAL_COMPLEX_REQUIRED", "주거단지는 NULL일 수 없습니다."),
    ...
    REVIEW_COUNT_INVALID(HttpStatus.BAD_REQUEST, "REVIEW_COUNT_INVALID", "리뷰 개수는 0개 이상이어야 합니다."),
    REVIEW_COUNT_REQUIRED(HttpStatus.BAD_REQUEST, "REVIEW_COUNT_REQUIRED", "리뷰 개수는 NULL일 수 없습니다."),
