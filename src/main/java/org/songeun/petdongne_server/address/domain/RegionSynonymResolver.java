...
@Component
public class RegionSynonymResolver implements SynonymResolver {

    // todo 환경변수로 전환
    private Map<String, String> regionMap = Map.ofEntries(
            Map.entry("경남", "경상남도"),
            Map.entry("경북", "경상북도"),
            Map.entry("경북도", "경상북도"),
            Map.entry("서울시", "서울특별시"),
    ...
    public String resolveOrGet(String keyword) {
