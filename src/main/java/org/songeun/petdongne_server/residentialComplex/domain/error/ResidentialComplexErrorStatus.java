...
public enum ResidentialComplexErrorStatus implements ErrorStatus {
    ...
    TRANSACTION_DATE_REQUIRED(HttpStatus.BAD_REQUEST, "TRANSACTION_DATE_REQUIRED", "거래일자는 NULL일 수 없습니다."),
    ...
    TRANSACTION_PRICE_REQUIRED(HttpStatus.BAD_REQUEST, "TRANSACTION_PRICE_REQUIRED", "거래금액은 NULL일 수 없습니다."),
