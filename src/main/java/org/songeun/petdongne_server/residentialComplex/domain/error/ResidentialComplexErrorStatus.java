...
public enum ResidentialComplexErrorStatus implements ErrorStatus {
    ...
    RESIDENTIAL_COMPLEX_TYPE_REQUIRED(HttpStatus.BAD_REQUEST, "RESIDENTIAL_COMPLEX_TYPE_REQUIRED", "존재하지 않는 주거 단지 유형입니다."),
    ...
    APPROVE_DATE_OF_RESIDENTIAL_COMPLEX_IS_FUTURE(HttpStatus.BAD_REQUEST, "RESIDENTIAL_COMPLEX_APPROVE_DATE_IS_AFTER_TODAY", "사용 승인일은 과거 또는 현재여야합니다."),
    APPROVE_DATE_OF_RESIDENTIAL_COMPLEX_IS_REQUIRED(HttpStatus.BAD_REQUEST, "APPROVE_DATE_OF_RESIDENTIAL_COMPLEX_IS_REQUIRED", "사용 승인일은 NULL일 수 없습니다."),
